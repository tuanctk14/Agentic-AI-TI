"""
ATI Reliable Chat Agent -  Two-Phase Architecture
...
SUMMARIZE_PROMPT = """You are ATI AI, a cybersecurity threat intelligence analyst.
...
async def reliable_chat(question: str, db: AsyncSession, provider: str = "ollama") -> dict:
    ...
    """
    from ati.services.ai_pipeline_hooks import _provider as _get_provider
    ...
    if provider == "anthropic":
        from ati.agent.agent_core import _call_anthropic as llm_call
    elif provider == "openai":
        from ati.agent.agent_core import _call_openai as llm_call
    elif provider == "google":
        from ati.agent.agent_core import _call_google as llm_call
    else:
        from ati.agent.agent_core import _call_ollama as llm_call
