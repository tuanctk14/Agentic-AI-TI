...
from ati.models import Detection, SeverityLevel, DetectionStatus, CustomerAsset
...
async def fetch_phishtank(client: httpx.AsyncClient) -> list[dict]:
    ...
    try:
        ...
        resp = await client.get(
            ...
            timeout=20.0, headers={"User-Agent": "ATI/8.0"})
    ...
    try:
        resp = await client.get(
            ...
            timeout=30.0, headers={"User-Agent": "ATI/8.0"},
