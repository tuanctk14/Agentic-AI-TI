...
from ati.models import Detection, CustomerAsset, DetectionStatus, Finding
...
async def route_detection(detection: Detection, db: AsyncSession) -> list[int]:
    ...
    if not matches and detection.ioc_type == "cve_id":
        from ati.engine.customer_router import RoutedDetection
                    ...
                    if ai_triage:
                      try:
                        ...
                        if _pipeline_ai_available():
                            from ati.models import Customer as _CustAI, SeverityLevel as _SevAI
