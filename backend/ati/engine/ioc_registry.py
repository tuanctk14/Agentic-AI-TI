...
USAGE:
  from ati.engine.ioc_registry import get_registry, get_type, calculate_dynamic_severity
...
async def seed_from_legacy(db: AsyncSession):
    ...
    try:
        from ati.engine.severity_scorer import IOC_SLA_MAP, IOC_MITRE_MAP
        from ati.engine.campaign_detector import IOC_KILL_CHAIN
        from ati.engine.playbooks import get_playbook
