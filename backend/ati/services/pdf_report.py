"""
PDF Report Generator - EVN branded.
...
from ati.models import (Detection, Customer, CustomerAsset, RemediationAction,
...
def _build_pdf(data: dict) -> bytes:
    ...
    recs.append("Review ATI collector schedule - ensure all free collectors are active and running on schedule.")
...
async def generate_pdf_report(customer_id: int, period_days: int = 30) -> dict:
    ...
    try:
        ...
        fname = f"ATI_{safe_name}_{ts}.pdf"
