...
async def _load_prompt(hook_name: str, industry: str = "") -> str:
    ...
    """
    try:
        from ati.engine.ai_prompt_manager import _prompt_cache, DEFAULT_PROMPTS
...
async def hook_ai_triage(
    ...
    _rag_ctx = ""
    try:
        from ati.services.ai_rag_context import build_rag_context
        from ati.database import async_session as _rag_session
...
async def hook_investigation_narrative(
    ...
    try:
        from ati.services.ai_rag_context import build_rag_context
        from ati.database import async_session as _rag_session_n
...
async def hook_rescore_severity(
    ...
    try:
        from ati.services.ai_rag_context import build_rag_context
        from ati.database import async_session as _rs
