...
from ati.models import (Customer, ThreatActor, CustomerExposure, Detection, ExposureHistory,
            ...
            for customer in cust_r2.scalars().all():
                try:
                    ...
                    try:
                        ...
                        if top:
                            from ati.engine.exposure_scorer import _dim3_actor_intent
...
async def get_customer_risk_summary(customer_id: int, db) -> dict:
    ...
    """
    from sqlalchemy import select, func, and_
    from ati.models import (Customer, CustomerExposure, ThreatActor,
    ...
    if overall_score == 0:
        from ati.models import Finding as _F
